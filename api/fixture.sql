...
create table if not exists fragrance_oils (
  ...
  reference_id int,
  order_id int,
  weight_ounces decimal(13, 8),
  remaining decimal(13, 8),
...
create table if not exists jar_reference (
  ...
  name varchar(255) not null,
  slug varchar(255) not null,
  overflow_volume_ounces decimal(13, 8),
  wax_to_fill_line_ounces decimal(13, 8),
  wax_to_overflow_ounces decimal(13, 8),
  diameter_inches decimal(13, 8),
  supplier_id int,
  product_url varchar(2083),
  msds_url varchar(2083),
  info_url varchar(2083),
...
create table if not exists batches (
  ...
  total_wax_weight_ounces decimal(13, 8),
  total_fragrance_weight_ounces decimal(13, 8),
  total_additive_weight_ounces decimal(13, 8),
  total_dye_weight_ounces decimal(13, 8),
  -- percent fragrance by weight
  fragrance_load decimal(13, 8),
...
create table if not exists candles_burns (
  ...
  stopped_weight_ounces decimal(13, 8),
  notes text,
  foreign key (candle_id) references candles(id)
);